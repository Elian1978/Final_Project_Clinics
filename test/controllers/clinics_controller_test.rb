...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { adress: @clinic.adress, email: @clinic.email, information: @clinic.information, name: @clinic.name, phone: @clinic.phone } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { adress: @clinic.adress, email: @clinic.email, information: @clinic.information, name: @clinic.name, phone: @clinic.phone } }
